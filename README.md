...
By default it use the eth0 network interface. You can find your network interface with ifconfig then modify those two lines with the name of the network interface :
